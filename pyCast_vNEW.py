...
#%%
def visualize_ckets(all_coords, pockets, n=5, trajectories=None, output_file=None):
    """
    ...
    for pdb_file in pdb_files:
        ...
        if best_pockets:
            ...
            if output_dir:
                ...
                # visualize_ckets(protein_coords, best_pockets, n=top_n, trajectories=best_trajectories, output_file=output_file)
        else:
...
# #%%
# pdb_directory = r'./Astex_toy'
# pdb_directory = r'./Natalia'
pdb_directory = r'./setPocketPicker'
min_pocket_size = 0.1
top_n_pockets = 3
output_directory = r'./output'
# output_directory = r'./output_Natalia'
alpha_range = [1.5, 3.5]
...
# alpha_range = [1.1, 4]  # Range di alpha da testare
# proximity_threshold = 4.0
